    ...
    return (
        <div style={{ minHeight: '100vh', background: '#020617', color: '#fff', padding: isMobile ? '2rem 1rem' : '4rem 2rem', fontFamily: 'sans-serif' }}>
            <div style={{ maxWidth: '1400px', margin: '0 auto' }}>
                ...
                {/* 🗺️ 核心升級 3：Duolingo 任務地圖 */}
                <div style={{ background: '#0f172a', borderRadius: '24px', padding: '3rem 1rem', border: '1px solid #1e293b', marginBottom: '4rem', display: 'flex', flexDirection: 'column', alignItems: 'center', position: 'relative' }}>
                    <h2 style={{ color: '#38bdf8', marginBottom: '2rem' }}>🗺️ 聽力特訓地圖</h2>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '3rem', position: 'relative' }}>
                        ...
                        {CARDS_DATA.map((node, index) => {
                            ...
                            // 判斷是否為「下一個可挑戰」的關卡（前一關解鎖，或本身是第一關）
                                ...
                                <div style={{ padding: '1.5rem' }}>
                                    ...
                                    {isUnlocked ? (
                                        ...
                                        <div style={{ borderTop: '1px dashed #334155', paddingTop: '1.5rem', textAlign: 'center' }}>
                                            ...
                                            <button onClick={() => handleStartTraining(card)} style={{ padding: '10px 20px', background: '#1e293b', color: '#38bdf8', border: '1px solid #38bdf8', borderRadius: '8px', cursor: 'pointer', fontWeight: 'bold', transition: '0.2s', marginTop: '10px' }} onMouseOver={e => e.currentTarget.style.background = 'rgba(56,189,248,0.1)'} onMouseOut={e => e.currentTarget.style.background = '#1e293b'}>
                                                前往挑戰解鎖 ➔
                                            </button>
                                        </div>
                                    )}
