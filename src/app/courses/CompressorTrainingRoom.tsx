...
const MISSIONS = [
    ...
    },
    {
        ...
        // 🎯 精準狙擊版：Threshold -32，Ratio 6
        target: { threshold: -32, ratio: 6, attack: 3, release: 150, knee: 15 },
        file: '/vocal-dry.mp3'
    },
    {
        id: 'guitar_strum',
        ...
        // 🎯 精準狙擊版：Threshold -34，Ratio 5
        target: { threshold: -34, ratio: 5, attack: 10, release: 100, knee: 15 },
