...
const grooveQuestions = [
    ...
    },
    {
        ...
        fileA: '/audio/groove/q2unaligned.mp3',
        fileB: '/audio/groove/q2locked.mp3',
        correct: 'B',
    ...
    },
    {
        ...
        fileA: '/audio/groove/q3flat.mp3',
        fileB: '/audio/groove/q3groove.mp3',
        correct: 'B',
            ...
            <div style={{ minHeight: '100vh', background: '#020617', display: 'flex', alignItems: 'center', justifyContent: 'center', padding: '2rem 1rem' }}>
                <div style={{ background: 'linear-gradient(145deg, #1e1b4b, #0f172a)', border: '1px solid rgba(167, 139, 250, 0.3)', padding: isMobile ? '2.5rem 1.5rem' : '4rem 2rem', borderRadius: '24px', textAlign: 'center', maxWidth: '550px', width: '100%', backdropFilter: 'blur(10px)', animation: 'fadeIn 0.5s', boxShadow: '0 20px 40px rgba(0,0,0,0.5)' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <button onClick={() => router.push('/courses/arrangement/groove-theory')} style={{ width: '100%', padding: '1.2rem', background: 'linear-gradient(135deg, #f97316, #ea580c)', color: '#fff', border: 'none', borderRadius: '50px', fontSize: '1.2rem', fontWeight: '900', cursor: 'pointer', boxShadow: '0 10px 20px rgba(234, 88, 12, 0.4)' }}>
                            🚀 我要變穩 (進入正式訓練) ➔
                        </button>
