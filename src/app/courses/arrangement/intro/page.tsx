        ...
        <div style={{ minHeight: '100vh', background: '#020617', color: '#f8fafc', padding: isMobile ? '1.5rem 1rem' : '4rem 2rem', fontFamily: 'sans-serif' }}>
            <div style={{ maxWidth: '1000px', margin: '0 auto' }}>
                ...
                <section style={{ marginBottom: '6rem' }}>
                    <div style={{
                        background: 'linear-gradient(135deg, rgba(16, 185, 129, 0.03), rgba(56, 189, 248, 0.08))',
                        padding: isMobile ? '2rem' : '2.5rem 3rem', borderRadius: '24px',
                        border: '1px solid rgba(56, 189, 248, 0.25)', display: 'flex', flexDirection: isMobile ? 'column' : 'row',
                        alignItems: 'center', gap: '2.5rem', boxShadow: '0 15px 35px rgba(0,0,0,0.4)'
                    }}>
                        <div style={{ flex: 1 }}>
                            <span style={{ fontSize: '0.85rem', color: '#10b981', fontWeight: 'bold', letterSpacing: '3px' }}>INTERACTIVE EXPERIMENT</span>
                            <h3 style={{ color: '#fff', fontSize: '1.6rem', margin: '0.5rem 0 1rem 0', fontWeight: 'bold' }}>第一步：親自解剖樂團舞台</h3>
                            <p style={{ color: '#cbd5e1', margin: 0, lineHeight: '1.7', fontSize: '1.05rem' }}>
                                在看字典之前，先戴上耳機進來玩玩看！<br />
                                我們為你準備了一個虛擬聲學空間，你可以自由拖拽主唱、大鼓、木吉他的左右耳位置。親耳聽聽看樂器全部擠在中間的「單聲道悲劇」，以及高手是怎麼配置 3D 舞台的。
                            </p>
                        </div>
                        <Link href="/courses/arrangement/sonic-lab" style={{
                            padding: '1.2rem 2.5rem', background: 'linear-gradient(135deg, #10b981, #38bdf8)', color: '#020617',
                            textDecoration: 'none', fontSize: '1.1rem', fontWeight: '900', borderRadius: '16px',
                            boxShadow: '0 10px 25px rgba(56, 189, 248, 0.25)', textAlign: 'center', whiteSpace: 'nowrap', transition: 'transform 0.2s'
                        }}
