...
export default function ArrangementIntro() {
    ...
    const cardStyle = {
        ...
        boxSizing: 'border-box' as const, // 確保 padding 不會撐破寬度
        width: '100%',
    ...
    return (
        <div style={{
            ...
            fontFamily: 'sans-serif', overflowX: 'hidden' // 防止整個頁面出現水平滾動條
        }}>
            ...
            <div style={{ maxWidth: '1000px', margin: '0 auto', width: '100%' }}>
                ...
                <header style={{ textAlign: 'center', marginBottom: isMobile ? '3rem' : '5rem' }}>
                    ...
                    <h1 style={{
                        fontSize: isMobile ? '2.2rem' : '4rem', fontWeight: '900', margin: '0 0 1rem 0',
                        lineHeight: '1.3', wordBreak: 'keep-all' // 防止中文字在奇怪的地方斷行
                    }}>
                ...
                <section style={{
                    ...
                    borderRadius: '24px', padding: isMobile ? '1.5rem' : '4rem', marginBottom: isMobile ? '3rem' : '5rem',
                    boxShadow: '0 20px 40px rgba(0,0,0,0.3)', width: '100%', boxSizing: 'border-box'
                }}>
                    <div style={{ display: 'flex', flexDirection: isMobile ? 'column' : 'row', gap: isMobile ? '2rem' : '3rem', alignItems: 'center' }}>
                        ...
                        <div style={{ flex: 1, display: 'flex', flexDirection: 'column', gap: '1rem', width: '100%' }}>
                            <div style={{ background: 'rgba(0,0,0,0.4)', padding: '1.2rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                ...
                                <p style={{ color: '#94a3b8', margin: 0, fontSize: '0.95rem' }}>浪漫愛情片還是動作爽片？決定曲風與節奏速度。</p>
                            </div>
                            <div style={{ background: 'rgba(0,0,0,0.4)', padding: '1.2rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                <h4 style={{ color: '#f97316', margin: '0 0 0.5rem 0', fontSize: '1.1rem' }}>🎸 角色分配</h4>
                                <p style={{ color: '#94a3b8', margin: 0, fontSize: '0.95rem' }}>該用溫暖的木吉他，還是具備侵略性的合成器？</p>
                            </div>
                            <div style={{ background: 'rgba(0,0,0,0.4)', padding: '1.2rem', borderRadius: '16px', border: '1px solid rgba(255,255,255,0.05)' }}>
                                <h4 style={{ color: '#e2e8f0', margin: '0 0 0.5rem 0', fontSize: '1.1rem' }}>🎢 劇情轉折</h4>
                                <p style={{ color: '#94a3b8', margin: 0, fontSize: '0.95rem' }}>運用 Reverse FX 與 Build-up 巧思，引爆副歌能量。</p>
                            </div>
                        </div>
                ...
                <section style={{ textAlign: 'center', marginTop: isMobile ? '4rem' : '6rem', paddingBottom: '3rem' }}>
                    <button
                        ...
                        style={{
                            ...
                            width: isMobile ? '100%' : 'auto', // 手機版撐滿全寬度方便點擊
