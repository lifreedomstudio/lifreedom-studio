        ...
        <div ref={containerRef} style={{ position: 'relative', height: '150vh', width: '100%', marginBottom: '0' }}>
            ...
            <div style={{ position: 'sticky', top: 0, height: '100vh', display: 'flex', flexDirection: 'column', alignItems: 'center', justifyContent: 'center', overflow: 'hidden' }}>
                ...
                <div style={{ position: 'absolute', top: isMobile ? '8%' : '12%', textAlign: 'center', zIndex: 10 }}>
                    ...
                    <div style={{ background: 'rgba(255,255,255,0.05)', padding: '10px 20px', borderRadius: '50px', border: '1px solid rgba(255,255,255,0.1)', display: 'inline-block' }}>
                        <span style={{ color: '#fca311', fontWeight: 'bold', letterSpacing: '1px', fontSize: isMobile ? '0.95rem' : '1.15rem' }}>
                            留白 (Silence) × 落差 (Contrast) × 推進 (Motion)
                        </span>
                    </div>
                </div>
                ...
                <div style={{ position: 'absolute', top: '50%', zIndex: 10, textAlign: 'center', width: '100%', padding: '0 1rem', height: '160px' }}>
                    ...
                    <div style={{
                        ...
                        <h2 style={{ fontSize: isMobile ? '1.5rem' : '2rem', color: '#facc15', fontWeight: '900', margin: '0 0 1rem 0' }}>能量落差 與 動態推進</h2>
                ...
                <div style={{ width: '100%', maxWidth: '1000px', position: 'absolute', bottom: isMobile ? '2%' : '5%' }}>
                    ...
                    <svg viewBox="0 0 1000 250" style={{ width: '100%', height: 'auto', overflow: 'visible' }}>
                        ...
                        <g fill={phase === 'burst' ? '#fff' : "#64748b"} fontSize="14" fontFamily="sans-serif" fontWeight="bold" style={{ transition: 'fill 0.5s' }}>
                            <text x="50" y="240">主歌 (Verse)</text>
                            <text x="350" y="240">導歌 (Pre)</text>
                            <text x="600" y="240">副歌 (Chorus)</text>
                        </g>
                    </svg>
                </div>
                ...
                <section style={{ background: 'rgba(255,255,255,0.01)', border: '1px solid rgba(255,255,255,0.05)', padding: isMobile ? '1.5rem' : '2.5rem', borderRadius: '24px' }}>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '1rem' }}>
                        <div style={{ background: 'rgba(15, 23, 42, 0.6)', padding: '1.2rem 1.5rem', borderRadius: '12px', borderLeft: '4px solid #10b981', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <div><span style={{ fontWeight: 'bold', color: '#fff', fontSize: '1.1rem' }}>主歌 (Verse)</span><br /><span style={{ color: '#94a3b8', fontSize: '0.9rem' }}>穩定敘事，鋪陳情節</span></div>
                        ...
                        <div style={{ background: 'rgba(15, 23, 42, 0.6)', padding: '1.2rem 1.5rem', borderRadius: '12px', borderLeft: '4px solid #facc15', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <div><span style={{ fontWeight: 'bold', color: '#fff', fontSize: '1.1rem' }}>導歌 (Pre-Chorus)</span><br /><span style={{ color: '#94a3b8', fontSize: '0.9rem' }}>堆疊懸念，製造渴望</span></div>
                        ...
                        <div style={{ background: 'rgba(15, 23, 42, 0.6)', padding: '1.2rem 1.5rem', borderRadius: '12px', borderLeft: '4px solid #38bdf8', display: 'flex', justifyContent: 'space-between', alignItems: 'center' }}>
                            <div><span style={{ fontWeight: 'bold', color: '#fff', fontSize: '1.1rem' }}>副歌 (Chorus)</span><br /><span style={{ color: '#94a3b8', fontSize: '0.9rem' }}>核心主題釋放，音場全開</span></div>
                    ...
                    <div style={{ display: 'flex', flexDirection: 'column', gap: '0.8rem', marginTop: '1rem' }}>
                        {[
                            ...
                            { id: 'bridge', title: '橋段 (Bridge)', desc: '迎來劇情大反轉。通常和弦走向會劇烈改變或節奏瞬間慢下，提供新鮮感。' },
                            { id: 'outro', title: '尾奏 (Outro)', desc: '故事終章消散。樂器一件件有序抽離，引導大腦情緒平復。' }
                        ].map((item) => {
