...
export default function PrivacyPolicy() {
    return (
        <div className="max-w-3xl mx-auto px-6 py-12 text-gray-800 leading-relaxed">
            <h1 className="text-3xl font-bold mb-2 text-slate-900">Privacy Policy for MixDojo</h1>
            ...
            <h2 className="text-xl font-bold mt-8 mb-4 text-slate-900">1. Information Collection and Use</h2>
            <p className="mb-4">
                We collect several different types of information for various purposes to provide and improve our Service to you.
            </p>

            <h3 className="text-lg font-semibold mt-6 mb-2 text-slate-900">Types of Data Collected:</h3>
            <ul className="list-disc pl-6 mb-6 space-y-2">
                <li>
                    <strong>Personal Data:</strong> While using our Service, we may ask you to provide us with certain personally identifiable information that can be used to contact or identify you. This includes, but is not limited to, your <strong>Email address</strong>.
                </li>
                <li>
            ...
            <h2 className="text-xl font-bold mt-8 mb-4 text-slate-900">2. Use of Data</h2>
            ...
            <h2 className="text-xl font-bold mt-8 mb-4 text-slate-900">3. Transfer and Disclosure of Data</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-bold mt-8 mb-4 text-slate-900">4. Security of Data</h2>
            <p className="mb-6">
            ...
            <h2 className="text-xl font-bold mt-8 mb-4 text-slate-900">5. Changes to This Privacy Policy</h2>
            <p className="mb-6">
                We may update our Privacy Policy from time to time. We will notify you of any changes by posting the new Privacy Policy on this page.
            </p>

            <h2 className="text-xl font-bold mt-8 mb-4 text-slate-900">6. Contact Us</h2>
            <p className="mb-4">
                If you have any questions about this Privacy Policy, please contact us by email:
            </p>
            <a href="mailto:luoweikai@gmail.com" className="text-blue-600 hover:underline font-medium">
                luoweikai@gmail.com
            </a>
        </div>
    );
